    ...
    <section class="container-fluid py-2">
        ...
        <div class="container-md justify-content-center">
            <div class="text-center">
                <img src="pics/DefaultProf.png" height="301" style="border-radius:50%;">
                <h2 class="mt-3 text-dark fw-bold">Adi Nugroho</h2>
            </div>
            <section class="container-md bg-light mt-3 mt-md-5 py-3 py-md-5" id="bio">
                <div class="container-md py-3 py-md-5 align-items-center justify-content-center" id="upload">
                ...
                <div class="container-md pt-3 pt-md-5 align-items-center justify-content-center" id="dataTable">
                    <table class="container-fluid">
                        <tr class="row mb-3">
                            ...
                            <td class="col-6">adi.nugroho@gmail.com</td>
                        </tr>
                        <tr class="row mb-3">
                            <td class="col-6">Sekolah</td>
                            <td class="col-6">SMPN 29 Bandung</td>
                        </tr>
                        <tr class="row mb-3">
                            <td class="col-6">Alamat</td>
                            <td class="col-6">Jawa Barat, Bandung</td>
                        </tr>
                        <tr class="row mb-3">
                            <td class="col-6">No. HP</td>
                            <td class="col-6">+62 896 9440 0001</td>
                        </tr>
                        <tr class="row mb-1">
