    ...
    <section class="container-md py-2">
        ...
        <div class="row justify-content-center mb-3 mb-md-5" id="firstRow">
            <div class="col-md-3 col-auto mb-4 mb-md-0 text-center">
                ...
                <h4 class="mt-4">Diky Ramdani, M.Pd</h4>
                <h5 class="fw-bold" style="color:#06B6D4;">Branch Manager</h5>
            </div>
            <div class="col-md-3 col-auto mb-4 mb-md-0 text-center">
                <img src="pics/Ridha.png" style="border-radius:50%;">
                <h4 class="mt-4">Ridha Aska Amanda, M.Pd</h4>
                <h5 class="fw-bold" style="color:#06B6D4;">Academic Manager</h5>
            </div>
        </div>
        ...
        <div class="row justify-content-center mb-3 mb-md-5" id="secondRow">
            <div class="col-md-3 col-auto mb-4 mb-md-0 text-center">
                ...
                <h4 class="mt-4">Lin Sundari, S.Pd</h4>
                <h5 class="fw-bold" style="color:#06B6D4;">Instructor</h5>
            </div>
            <div class="col-md-3 col-auto mb-4 mb-md-0 text-center">
                <img src="pics/Nida.png" style="border-radius:50%;">
                <h4 class="mt-4">Nida Ainun Najmillah, S.Pd</h4>
                <h5 class="fw-bold" style="color:#06B6D4;">Instructor</h5>
            </div>
            <div class="col-md-3 col-auto mb-4 mb-md-0 text-center">
                <img src="pics/Rizal.png" style="border-radius:50%;">
                <h4 class="mt-4">Rizal Anthony, S.Pd</h4>
                <h5 class="fw-bold" style="color:#06B6D4;">Instructor</h5>
            </div>
            <div class="col-md-3 col-auto mb-4 mb-md-0 text-center">
                <img src="pics/Liban.png" style="border-radius:50%;">
                <h4 class="mt-4">Liban Hasen Abdi</h4>
                <h5 class="fw-bold" style="color:#06B6D4;">Instuctor<br>(Native Teacher)</h5>
            </div>
        </div>
